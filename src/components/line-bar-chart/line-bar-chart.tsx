...
//         time: searchField.type === TypeFilterDate.day
...
//       //       max: moment(searchField.to).add(1, 'm').valueOf()
//       //     }
//       //   },
//       //   zoom: {
//       //     mode: 'x',
...
//   //     },
//   //     tooltip:
//   //         selectUnit === OptionParam.ALARM_STATUS && searchField.type ===TypeFilterDate.day
//   //         ?
//   //           {
//   //             enabled: false,
...
//   //                       itemData?.dataset?.parsing?.yAxisKey?.replace('.count', '')
//   //                     ]?.info;
//   //                     dataWithDataset && (innerHtml += `<tr><td>------------${itemData.dataset.parsing.yAxisKey.replace(
//   //                     '.count',
//   //                     ''
//   //                   )}: ${(dataLabel ?? {})[
//   //                     itemData.dataset.parsing.yAxisKey.replace('.count', '')
...
//       const tooltipEl = document.getElementById('chartjs-tooltip') || { style: {opacity: 1}};
//       tooltipEl.style.opacity = 0;   
//     }
...
//         ) : (
//           <>
//             {searchField.type === TypeFilterDate.day && selectUnit !== OptionParam.ALARM_STATUS ? (
