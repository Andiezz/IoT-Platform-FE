...
const ChangePassword: React.FC = () => {
  ...
  const handleChangePassword = async (values: IChangePasswordBody) => {
    await authService
      .changeForgotPassword({ ...values, token })
      .then((rs) => {
        setLoading(false);
  ...
  const onFinishFailed = () => {
    message.error(
      `${t(i18nKey.validation.emailOrPassword.changePasswordFail)}`
    );
  };
        ...
        <Form
            ...
            <Col span={24}>
              <div className={styles.changePassword_title}>
                <Typography.Title level={1}>
                  {t(i18nKey.loginPage.createNewPasswordTitle)}
                </Typography.Title>
              </div>
            </Col>
          </Row>
              ...
              <Form.Item
                ...
                rules={[
                  ...
                  },
                  {
                    ...
                    message: `${t(
                      i18nKey.validation.emailOrPassword.passwordPattern
                    )}`
                  }
                ]}>
                <Input
          ...
          <Row>
            <Col span={24}>
              ...
              <Link
                to={PAGE_ROUTE.LOGIN}
                className={styles.changePassword_back}>
                <Button>
        ...
        <div style={{ width: '100%' }}>
          <Row style={{ textAlign: 'center' }}>
            ...
            <Col span={24}>
              <div className={styles.changePassword_title}>
                <Typography.Title level={1}>
                  {t(i18nKey.accountEntity.title.changePassword)}
                </Typography.Title>
              </div>
            </Col>
            <Col span={24}>
            ...
            <Col span={24}>
              <Link to={PAGE_ROUTE.LOGIN}>
                <Button className={styles.btnBack} type="primary" block>
                  <b>{t(i18nKey.loginPage.loginTitle)}</b>
                </Button>
              </Link>
            </Col>
          </Row>
